...
class HelpfulError(MusicbotException):
    ...
    def message(self):
        return ("\n{}\n{}\n{}\n").format(
            ...
            self._pretty_wrap(self.solution, "  Rozwiązanie: "))
    ...
    def message_no_format(self):
        return "\n{}\n{}\n{}\n".format(
            ...
            self._pretty_wrap(self.solution, "  Rozwiązanie: ", width=None))
